...
const includedPaths: string[] = [
  ...
  // 'components/AssetBriefReadOnly.vue',
  // 'components/CampaignBrief.vue',
  // 'components/CampaignBriefEditor.vue',
  // 'components/CampaignBriefReadOnly.vue',
  // 'components/CampaignContentOutputs.vue',
  // 'components/CampaignContentTable.vue',
  // 'components/CampaignTable.vue',
  // 'components/ConfirmDialog.vue',
  // 'components/ContentBriefEditor.vue',
  // 'components/ContentElementsViewer.vue',
  // 'components/ContentSelectionButtons.vue',
  // 'components/ContentSelectionModal.vue',
  // 'components/ContentTable.vue',
  // 'components/ContentTypeEditModal.vue',
  // 'components/ContentTypePanel.vue',
  // 'components/ContentValidation.vue',
  // 'components/ContentViewerFull.vue',
  // 'components/ContentViewerSimple.vue',
  // 'components/CreateViewCampaign.vue',
  // 'components/ExampleEditPanel.vue',
  // 'components/ExampleTable.vue',
  // 'components/ExamplesEmptyState.vue',
  // 'components/HelloWorld.vue',
  // 'components/SelectedContentTag.vue',
  // 'components/SubtypeSettingsHistory.vue',
  // 'components/ViewContent.vue',
  // 'components/VoiceSettingsEditor.vue',
  // 'components/VoiceSettingsHistory.vue',
  // 'components/VoiceSettingsReadOnly.vue',
  ...
  // 'server/api/voice/**/*',
  'server/api/voice/[id]/**/*',
  'server/api/voice/[id]/delete.ts',
  // 'server/api/voice/create.ts',
  // 'server/api/voice/get-by-org.get.ts',
  // 'server/api/voice/update-content-type-settings.ts',
  // 'server/api/voice/update.ts',
  // 'server/database.ts',
  // 'server/db/**/*',
  ...
  // 'services/contentFactory.ts',
  // 'services/useVoiceSettings.ts',
  ...
  // 'worker/src/promptGenerators/SnippetsProcessors/taskProcessor.ts',
  // 'worker/src/promptGenerators/SnippetsProcessors/voiceProcessor.ts',
